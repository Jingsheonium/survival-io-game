...
00:00:00.640 The process of creating tiles for games can get quite tedious,  
00:00:03.680 especially if you are working solo. Add a few different types like grass, dirt and paths,  
00:00:09.840 throw in some random variations, and then you may find yourself with hundreds of tiles to manage.  
00:00:15.880 In fact, assuming you have 8 neighbours for each tile, having a unique tile  
00:00:20.720 for each possible combination of neighbours would require 256 tiles!
00:00:26.200 Luckily, most of the time we can get away with much, much less than that.  
00:00:30.360 So what are our options? Today let’s compare 3 commonly used tilesets,  
00:00:35.840 and then I’d like to show you a really cool alternative called the dual-grid system.
00:00:40.880 Let’s start with the classic 15-piece tileset. Although it does not contain many tiles,  
00:00:46.200 it has one major problem. Because the edges are drawn through the middle of each tile,  
00:00:51.240 by default they don’t align with the world grid. This results in ambiguous tiles. Should  
00:00:57.640 this be considered dirt or grass? Also, the act of placing a single tile down results in a much  
00:01:03.800 larger area than expected, so interacting with them is quite confusing. Maybe if your tiles  
00:01:09.520 are purely decorative then you could make this work, it kind of depends on your game.
00:01:14.040 The next option is a 47-piece tileset. These tile edges are drawn closer to the grid edge,  
00:01:20.160 so they appear much more aligned with the rest of the game's world. The downside  
00:01:24.320 is that now significantly more tiles are required. It’s not as high as 256,  
00:01:29.640 but 47 is still quite the jump from 15!
00:01:33.520 Sometimes, you can get away with using a subset of these tiles. You just have to be careful with  
00:01:38.720 broken-looking inner corners. In my case I had to slightly expand all the tiles to  
00:01:43.960 make it less noticeable. The 16-piece subset is quick to make and is aligned to the world grid,  
00:01:50.920 but might not be compatible with all art styles, especially those with detailed inner corners.
00:01:57.480 Another consideration is that it is pretty hard to achieve equally rounded inner and  
00:02:01.400 outer corners with the last 2 options. It definitely comes down to personal preference,  
00:02:06.200 but I do tend to prefer the look of perfectly rounded tiles - especially for paths like these.
00:02:13.400 So, here are the tile sets we just went through. Unfortunately,  
00:02:16.880 each of them has at least one thing we have to compromise on.
00:02:20.400 This is why I think the dual-grid system is so neat,  
00:02:22.920 because it pretty much solves all these problems.
00:02:26.920 So, what is the dual-grid system? Well, like it’s name suggests, it uses two grids instead of one.  
00:02:34.080 The world grid keeps track of which tile is where, but doesn’t display anything. The second grid is  
00:02:39.760 offset from the world grid by half a tile, and each tile changes based on it’s 4 overlapping  
00:02:44.960 neighbours. This means there is only 16 possible configurations of neighbours, instead of 256.
00:02:55.240 In terms of the actual tileset to use with this method, this time we actually *want*  
00:02:59.240 the edges to be drawn halfway through each tile. Once the offset is applied,  
00:03:03.840 it will appear perfectly aligned with the rest of the game’s world.
00:03:08.080 For learning more about the dual-grid system, I recommend checking out this talk by Oskar  
00:03:12.120 Stalberg or this devlog by ThinMatrix, both of which I will link in the description.
